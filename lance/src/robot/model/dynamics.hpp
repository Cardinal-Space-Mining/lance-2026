...
CONSTEXPR_VAL_TEMPLATE(MINING_DEPTH_FX_OFFSET, 0.1112)
CONSTEXPR_VAL_TEMPLATE(MINING_DEPTH_FX_SLOPE, -0.3425)
CONSTEXPR_VAL_TEMPLATE(MINING_MAX_DEPTH_M, 0.1112)
#endif
